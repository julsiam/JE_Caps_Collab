            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        {{-- <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <a class="nav-link {{ request()->is('tenants') ? 'active' : null }}"
                                    aria-current="page" href="{{ url('/tenants') }}">
                                ...
                                <a class="nav-link {{ request()->is('tenants') ? 'active' : null }}"
                                    aria-current="page" href="{{ url('add_tenant') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <a class="nav-link {{ request()->is('tenants') ? 'active' : null }}"
                                    aria-current="page" href="{{ url('/edit_tenant') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('payment_records') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a data-count="0" class="nav-link" href="#notifications-panel"> <svg
