        ...
        <div class="row justify-content-center" style="margin-top:8%">
            ...
            <div class="col-md-6 text-end">
                ...
                <a href="" class="btn btn btn-outline-danger me-2"><svg xmlns="http://www.w3.org/2000/svg"
                        width="16" height="16" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
        ...
        <div class="container-fluid body-content mt-4">
                ...
                <table id="InventoryData" class="table table-bordered">
                    ...
                    <tbody>
                        @foreach ($tenants as $tenant)
                            <tr>
                                <td class="text-center" scope="row">{{ $tenant->id }}</td>
                                 <td class="text-center">{{ $tenant->user->first_name }} {{ $tenant->user->last_name }}</td>
                                 <td class="text-center">{{ $tenant->user->email }}</td>
                                 <td class="text-center">{{ $tenant->property->location }}</td>
                                 <td class="text-center">{{ $tenant->property->room_unit }}</td>
                                 <td class="text-center">{{ $tenant->due_date }}</td>
                                 <td class="text-center">
                                    <button class="btn btn-primary btn-sm">Profile</button>
                                    <button class="btn btn-primary btn-sm">Room Info</button>
                                </td>
                            </tr>
            ...
            <div class="col-xl-12">
                ...
                <div class="row mt-4" style=" float:right;">
                    <a style="cursor: pointer; margin-left: 10px; width: 140px;color:#fff;" href="{{ url('add_tenant') }}" class="btn btn-success me-2" class="btn btn-success me-2">
