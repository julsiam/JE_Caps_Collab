            ...
            <div style="margin-top:8%;" class="col-md-12">
                <form action="{{ route('announcements.search') }}" method="GET" class="mb-3">
                    <div class="input-group">
                        <input type="text" id="keyword" name="keyword" value="{{old('keyword')}}" class="form-control" placeholder="Search by subject or details">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('announcements.addAnnouncement') }}"
